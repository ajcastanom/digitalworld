...
<div class="container">
  ...
  <div class="sidebar1">
    ...
    <p> Los vínculos anteriores muestran una estructura de navegación básica emplea una lista no ordenada con estilo de CSS. Utilícela como punto de partida y modifique las propiedades para lograr el aspecto deseado. Si necesita menús desplegables, créelos empleando un menú de Spry, un widget de menú de Adobe Exchange u otras soluciones de javascript o CSS.</p>
