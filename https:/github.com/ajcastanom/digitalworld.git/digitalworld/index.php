...
<div class="container">
  ...
  <div class="logo_cabecera"><?php include("includes/cabecera.php"); ?>						  <!-- end .logo_cabecera --></div>
  <!-- Slider imagenes -->
  ...
  <img class="img_title" src="images/form_title.png" /></div>
  <div class="formulario">
  <?php include("includes/formulario.php"); ?></div>
  </div>
